...
// ---------------------------------------------------------------------------
// Keymap
// LAYOUT_split_4x6_5 expects 58 keys:
//   Left:  4 rows × 6 cols (24) + 5 thumb keys
//   Right: 4 rows × 6 cols (24) + 5 thumb keys
// ---------------------------------------------------------------------------
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_4x6_5(
        ...
        TT(1),   KC_LCTL, KC_LSFT, KC_SPC,  KC_LALT,
        ...
        TT(2),   KC_RCTL, KC_BSPC, SC_SENT, KC_ESC
    ),
    ...
    [1] = LAYOUT_split_4x6_5(
        ...
        TT(3),   KC_TRNS, KC_DEL,  KC_TRNS, KC_TRNS
    ),
    ...
    [2] = LAYOUT_split_4x6_5(
        ...
        TT(3),   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
